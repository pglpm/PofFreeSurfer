...
%% Created: 2020-10-28T21:29:34+0100
%% Last-Updated: 2020-11-25T16:24:44+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\firstdraft}{25 November 2020}
\newcommand*{\firstpublished}{\firstdraft}
\newcommand*{\updated}{\ifarxiv***\else\today\fi}
\newcommand*{\propertitle}{Notes: Quantification of uncertainty\\ in longitudinal segmentation%\\{\large ***}%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Uncertainty in longitudinal segmentation}
...
\usepackage[backend=bibtex,mcite,%subentry,
...
\newcommand*{\doi}[1]{%
\textsc{doi:}\href{https://doi.org/#1}{\texttt{#1}}%
}
...
% \footnotesize HVL, Bergen\quad\epost{\email{pgl}{portamana.org}}}%
%% uncomment if additional authors present
% \hspace*{\stretch{1}}%
% \parbox{0.5\linewidth}%\makebox[0pt][c]%
% {\protect\centering ***\\%
...
\mynote{\textsc{todo}: Reformulate \amp\ simplify
  \textcite{iglesiasetal2016} approach in terms of a hierarchic probability
  distribution.}

\section{Notes on Iglesias \etal's paper [Luca]}
\label{sec:notes_iglesiasetal}

Notes on \textcite{iglesiasetal2016}.

\begin{itemize}[wide]
\item The approximation on p.~545 left bottom can be very bad in high
  dimensions \citep{mackay1996}.
\item Use of probabilistically-labelled nodes: doesn't this introduce a
